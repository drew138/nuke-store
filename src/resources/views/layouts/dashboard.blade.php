    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="{{ route('admin.home.index') }}" class="flex items-center pl-2.5 mb-5">
                <img src="{{ asset('/images/app_logo_white.png') }}" class="h-6 mr-3 sm:h-7" alt="Nukestore Logo" />
                <span
                    class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{{ __('app.app_name') }}</span>
                <span
                    class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">{{ __('app.admin') }}</span>
            </a>
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('admin.reviews.index') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">{{ __('app.reviews') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.users.index') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">{{ __('app.users') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.bombs.index') }}"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">{{ __('app.bombs') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.orders.index') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">{{ __('app.orders') }}</span>
                    </a>
                </li>
                <li>
                    <form class="my-auto" id="logout" action="{{ route('logout') }}" method="POST">
                        @csrf
                        <a role="button" onclick="document.getElementById('logout').submit();"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">{{ __('app.log_out') }}</span>
                        </a>
                    </form>
                </li>
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap"
                            sidebar-toggle-item>{{ __('app.language') }}</span>
