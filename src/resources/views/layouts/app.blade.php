...
<head>
  ...
  <title>@yield('title', 'NukeStore')</title>
</head>
<body class="d-flex flex-column min-vh-100 bg-tertiary">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          ...
          <a class="nav-link active" href="{{ route('bomb.index') }}">Bombs</a>
          <a class="nav-link active" href="{{ route('bomb.create') }}">Create bomb</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <footer class="mt-auto copyright py-4 text-center text-white">
    <div class="container">
      <small>
