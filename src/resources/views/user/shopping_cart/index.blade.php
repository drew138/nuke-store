...
@section('content')
    <div class="w-full max-w-7xl mx-auto px-4 mb-24">
                ...
                <tbody>
                    @foreach ($data['bombs'] as $bomb)
                        <tr
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">{{ $bomb->getName() }}
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <form action="{{ route('shopping_cart.delete', ['id' => $bomb->getId()]) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button
        ...
        @if ($errors->any())
            <div
                class="w-full p-4 my-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
