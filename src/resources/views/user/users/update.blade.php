...
@section('content')
    <div class="w-full p-4 flex flex-col justify-center items-center">
        ...
        <div
            ...
            <form class="space-y-6" method="POST" action="{{ route('users.save_update') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                        for="profile_picture">{{ __('users.profile_picture') }}</label>
                    <input type="file" name="profile_picture" id="profile_picture" accept=".jpg,.jpeg,.bmp,.png,.gif"
