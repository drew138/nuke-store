...
@section('content')
    <div class="mx-auto max-w-6xl p-8 mb-24">
        <div
            ...
            <h4 class="p-2 text-2xl font-bold my-4 dark:text-white">{{ $data['user']->getName()  . __('users.user_bombs') }}</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div class="p-2">
                    <div
                        ...
                        <a href="#">
                            <img class="object-cover h-72 w-full rounded-t-lg"
                        ...
                        <div class="p-4">
                            <a href="#">
                                <h1
                                    ...
                                    <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-sky-400">La
                                        destroza planetas</span></h1>
                            </a>
                            <h5 class="text-xl text-center font-bold tracking-tight text-gray-900 dark:text-white">250000
                            </h5>
