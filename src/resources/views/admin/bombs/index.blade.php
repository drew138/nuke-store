                            ...
                            <tbody>
                                @foreach ($data['bombs'] as $bomb)
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $bomb->getId() }}</th>
                                        <td class="px-4 py-3">
                                            <img class="w-10 h-10 object-cover rounded"
                                                src="{{ URL::asset($bomb->getImage()) }}">
                                        </td>
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $bomb->getName() }}</th>
