...
@section('content')
    <div class="max-w-7xl h-[calc(100vh-230px)] mx-auto mb-28 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col items-center px-4 pt-4 pb-24 md:p-4 md:flex-row -mx-4">
            <div
                class="overflow-auto w-full max-w-full bg-white border border-green-700 rounded-lg shadow dark:bg-gray-800 dark:border-green-700">
                ...
                <div class="flex flex-col items-center pb-10">
                    <h1 class="text-3xl mx-8 mb-2 font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-6xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r to-green-800 from-green-600">
                            13050900</span></h1>
            ...
            <div
                class="overflow-auto w-full max-w-full m-4 bg-white border border-red-700 rounded-lg shadow dark:bg-gray-800 dark:border-red-600">
                <div class="flex flex-col items-center">
                    <h1 class="text-4xl m-8 font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-7xl"><span
                ...
                <div class="flex flex-col items-center pb-10">
                    <h1 class="text-3xl mx-8 mb-2 font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-6xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r to-red-600 from-red-500">
                            20000</span></h1>
                    <span class="text-sm text-gray-500 dark:text-gray-400">Megatons</span>
                </div>
            </div>
