...
@section('content')
    <div class="w-full max-w-7xl mx-auto px-4 mb-24">
        <h1 class="mt-8 mb-8 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-sky-400">{{__('shopping_cart.shopping_cart')}}</span></h1>
        ...
        <a type="button" href="#" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">{{__('shopping_cart.purchase_order')}}</a>
    </div>
@endsection
