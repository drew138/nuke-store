                        ...
                        <form method="POST" action="{{ route('reviews.save') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-2" id="title"
                                    placeholder="{{ __('reviews.enter_title') }}" name="title"
                                    value="{{ old('title') }}" />
                            </div>
                            <div class="form-group">
                                <label for="rating">{{ __('reviews.rating') }}</label>
                                <input type="number" class="form-control mb-2" id="rating"
                                    placeholder="{{ __('reviews.enter_rating') }}" name="rating"
                                    value="{{ old('rating') }}" />
                            </div>
                            <div class="form-group">
                                <label for="image">{{ __('reviews.image') }}</label>
                                <input type="text" class="form-control mb-2" id="image"
                                    placeholder="{{ __('reviews.enter_image') }}" name="image"
                                    value="{{ old('image') }}" />
                            </div>
                            <div class="form-group">
                                <label for="description">{{ __('reviews.description') }}</label>
                                <textarea type="text" class="form-control mb-2" id="description" placeholder="{{ __('reviews.enter_description') }}"
                                    name="description" value="{{ old('description') }}"></textarea>
                            </div>
                            <label for="is_verified_radio">{{ __('reviews.is_verified') }}</label>
                            <div class="form-check" id="is_verified_radio">
                                <input class="form-check-input" type="radio" name="is_verified" id="is_verified_true"
                                    value="1" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_verified" id="is_verified_false"
                                    value="0">
